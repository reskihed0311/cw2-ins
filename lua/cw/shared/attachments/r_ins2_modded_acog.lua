...
if CLIENT then
	...
	local old, x, y, ang
	local reticle = surface.GetTextureID("models/r_shared/rets/reticle_ta01")
	
	att.zoomTextures = {{tex = surface.GetTextureID("models/r_shared/rets/reticle_ta01"), offset = {0, 0}}}
