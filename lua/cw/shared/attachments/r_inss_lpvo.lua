local att = {}
att.name = "rlpvo"
att.displayName = "LPVO 1x8"
att.displayNameShort = "LPVO"
att.aimPos = {"LPVOPos", "LPVOAng"}
att.FOVModifier = 5
att.isSight = true
...
if CLIENT then
	...
	local old, x, y, ang
	local reticle = surface.GetTextureID("models/r_shared/rets/lpvo_reticle")
	
	att.zoomTextures = {{tex = surface.GetTextureID("models/r_shared/rets/lpvo_reticle"), offset = {0, 0}}}
